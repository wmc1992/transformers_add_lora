...
def main():
    ...
    def tokenize_function(examples):
        ...
        output = {"input_ids": [tokenizer.build_inputs_with_special_tokens(x) for x in output["input_ids"]]}
    ...
    data_collator_for_language_modeling = DataCollatorForLanguageModeling(
        tokenizer=tokenizer,
        mlm=False,
        return_tensors="pt",
    )
    ...
    trainer = Trainer(
        ...
        tokenizer=tokenizer,
        data_collator=data_collator_for_language_modeling,
